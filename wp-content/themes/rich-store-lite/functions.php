...
function rich_store_lite_setup() {		
	$GLOBALS['content_width'] = apply_filters( 'rich_store_lite_content_width', 670 );		
...
define('RICH_STORE_LITE_THEME_DOC',__('https://www.gracethemes.com/documentation/richstore/#homepage-lite','rich-store-lite'));
define('RICH_STORE_LITE_PROTHEME_URL',__('https://gracethemes.com/themes/ecommerce-marketplace-wordpress-theme/','rich-store-lite'));
define('RICH_STORE_LITE_LIVE_DEMO',__('https://www.gracethemes.com/demo/richstore/','rich-store-lite'));
 ...
 */
add_action( 'after_setup_theme', 'rich_store_lite_setup_woocommerce_support' );
function rich_store_lite_setup_woocommerce_support()   
{
 ...
 */
function rich_store_lite_skip_link_focus_fix() {  
...
add_action( 'wp_print_footer_scripts', 'rich_store_lite_skip_link_focus_fix' );